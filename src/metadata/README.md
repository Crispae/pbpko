 ...
 * [pbpko.yml](pbpko.yml)
     * Determines how your purl.obolibrary.org/obo/pbpko/ redirects will be handled
     ...
     * Paste in the contents of [pbpko.yml](pbpko.yml)
 ...
 * [pbpko.md](pbpko.md)
     ...
     * Paste in the contents of [pbpko.md](pbpko.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
